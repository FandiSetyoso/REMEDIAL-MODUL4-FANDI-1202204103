    ...
    <div class="container-fluid">
      <div class="row align-items-center">
        <div class="col-md-6 min-vh-100 left">
          <img src="imagelogin.jpg" style="object-fit:fill;height:100%;" alt="foto">
        </div>
        <div class="col-md-6">
          <div class="form-login m-auto ps-5">
            ...
            <form action="" method="post">
              ...
              <div class="text-center text-lg-start mt-4 pt-2">
                ...
                <p class="small fw-bold mt-2 pt-1 mb-0">Login sebagai <a href="Loginadmin.php" class="link-danger">Admin</a></p>
              </div>
            </form>
          </div>
